                ...
                <div class="flex min-h-screen flex-col lg:flex-row">
                    <aside class="w-full lg:w-72 xl:w-80 border-b lg:border-b-0 lg:border-r border-slate-200/80 bg-slate-950 text-slate-100">
                        ...
                        <nav class="space-y-1 px-4 py-5">
                            ...
                            @elseif($isTeacher)
                                <a href="{{ route('teacher.dashboard') }}" class="flex items-center gap-3 rounded-2xl px-3 py-3 text-sm font-semibold transition {{ request()->routeIs('teacher.dashboard') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/10 hover:text-white' }}">
                                    <span>◉</span>
                                    <span>Dashboard</span>
                                </a>
                        ...
                        <header class="border-b border-slate-200/80 bg-white/90 backdrop-blur">
                            <div class="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2 transition hover:border-slate-300 hover:bg-slate-100" aria-label="Edit profile" title="Edit profile">
