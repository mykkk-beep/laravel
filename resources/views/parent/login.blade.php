...
<div class="flex min-h-[calc(100vh-4rem)] items-center justify-center px-1 py-8 sm:px-0">
    ...
    <form method="POST" action="{{ route('parent.login.submit') }}">
        ...
        <div>
            ...
            <input id="student_id" name="student_id" class="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100" placeholder="Enter your child's student ID" required autofocus />
